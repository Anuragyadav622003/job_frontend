...
const MyJobs = () => {
    ...
    const fetchJobs = async () => {
      try {
        const { data } = await axios.get(
          `https://job-backend-eta.vercel.app/job/getmyjobs`,
  ...
  const handleUpdateJob = async (jobId) => {
    ...
    await axios
      .put(
        `https://job-backend-eta.vercel.app/job/updatejobs/${jobId}`,
        updatedJob,
        {
          withCredentials: true,
        }
  ...
  const handleDeleteJob = async (jobId) => {
    await axios
      .delete(`https://job-backend-eta.vercel.app/job/deletejob/${jobId}`, {
        withCredentials: true,
      })
      .then((res) => {
        toast.success(res.data.message);
