  ...
  return(
    <footer class="font-sans tracking-wide bg-[#213343] px-8 py-12">
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-10">
        ...
        <div>
          <h4 class="text-yellow-400 font-semibold text-lg relative max-sm:cursor-pointer">Services <svg
        ...
        <div>
          <h4 class="text-yellow-400 font-semibold text-lg relative max-sm:cursor-pointer">Platforms <svg
            xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
            class="sm:hidden absolute right-0 top-1 fill-[#d6d6d6]" viewBox="0 0 24 24">
            <path
              d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z"
        ...
        <div>
          <h4 class="text-yellow-400 font-semibold text-lg relative max-sm:cursor-pointer">Company <svg
            xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
            class="sm:hidden absolute right-0 top-1 fill-[#d6d6d6]" viewBox="0 0 24 24">
            <path
              d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z"
        ...
        <div>
          <h4 class="text-yellow-400 font-semibold text-lg relative max-sm:cursor-pointer">Additional <svg
            xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
            class="sm:hidden absolute right-0 top-1 fill-[#d6d6d6]" viewBox="0 0 24 24">
            <path
              d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z"
      ...
      <div class="flex flex-wrap max-md:flex-col gap-4">
        ...
        <p class='text-yellow-400 text-sm md:ml-auto'>Copyright © 2023<a href='https://readymadeui.com/'
